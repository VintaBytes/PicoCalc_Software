...
Titulo("TELEGRAM:")
PRINT
PRINT CENTRAR$("PRESIDENT JAMES K. POLK SENDS YOU HIS")
PRINT CENTRAR$(" HEARTIEST CONGRATULATIONS")
PRINT CENTRAR$("AND WISHES YOU A PROSPEROUS LIFE AHEAD")
PRINT CENTRAR$("AT YOUR NEW HOME")
PRINT
COLOR RGB(green)
FINAL_DEL_JUEGO
